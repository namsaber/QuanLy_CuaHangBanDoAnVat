...
<head>
    ...
    <title>{{ config('app.name', 'KFC Viet Nam') }}</title>
...
<body id="@yield('bodyID')">
    ...
    <div class="sidebar">
        ...
        <ul>
            @if (auth()->user()->role == 'admin')
                <li><a href="{{ route('dashboard') }}" id="sidebar-dashboard"><i class="fa fa-th-large"
                            aria-hidden="true"></i>Dashboard</a></li>
                <br>
                <li><a href="{{ route('kitchenOrder') }}" id="sidebar-orders"><i class="fa fa-shopping-cart"
                            aria-hidden="true"></i>Orders</a></li>
                <br>
                <li><a href="{{ route('menu') }}" id="sidebar-menu"><i class="fa fa-book"
                            aria-hidden="true"></i>Menu</a></li>
                <br>
                <li><a href="{{ route('discount') }}" id="sidebar-discount"><i class="fa fa-ticket"
                            aria-hidden="true"></i>Discount</a></li>
                <br>
                <li><a href="{{ route('accountCreation') }}" id="sidebar-account"><i class="fa fa-user"
            ...
            @endif
            <li>
                <a href="{{ route('logout') }}" id="sidebar-logout"
                    onclick="event.preventDefault();
